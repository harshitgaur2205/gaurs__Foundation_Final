  ...
  return (
    <div className="donate">
      ...
      <div className="contact_main">
        <h1>Donate</h1>
        <h3>One Step Closer To Help Millions</h3>
      </div>
      <svg
      ...
      >
        ...
        <div className="donate_bottom">
          ...
          >
            At Gaur's Foundation, our mission is simple yet profound: to unite
            urban communities in a shared purpose of compassion, donation, and
            support. We understand the strength that lies within urban areas and
            aim to harness this strength for the betterment of society.
          </motion.h4>

          <form
            action="https://formspree.io/f/mkgwnoan"
            method="POST"
            className="form"
          >
            <motion.div
            ...
            >
              ...
              <motion.h2
                ...
                whileInView={{ opacity: 1, scale: [0.5, 1, 1.5, 2, 1.5, 1] }}
              ...
              <div className="form-group choices">
                <div className="choice">
                  <input
                    ...
                    required
                  />
                  <label htmlFor="finance" className="option-label">
                    Finance
                  </label>
                </div>
                ...
                <div className="choice">
                  <input
                    ...
                    value="Clothes"
                  />
                  <label htmlFor="clothes" className="option-label">
                    Clothes
                  </label>
                </div>
                ...
                <div className="choice">
                  <input
                    ...
                    value="Others"
                  />
                  <label htmlFor="others" className="option-label">
                    Others
                  </label>
                </div>
              </div>
      ...
      <Footer className="footer_donate" />
    </div>
  );
};
