...
const page = () => {
    const data = [
        ...
        },
        {
            ...
            heading:"RURAL RESEARCH AND DEVELOPMENT",
            discription:"Maximizes  impact of poverty alleviation initiatives for rural communities through using participatory research."
        }
    ]
  return (
    <>
